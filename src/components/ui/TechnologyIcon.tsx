...
const SKILL_ICONS: Record<string, SkillIcon> = {
  ...
  "REST APIs": { Icon: TbApi, color: BLUE },
  ...
  "AI/ML Integration": { Icon: Brain, color: BLUE },
  ...
  // APIs
  "Gemini API": { Icon: Sparkles, color: "#8E75B2" },
  "Web Speech API": { Icon: MessageCircle, color: BLUE },
  ...
  "Backend Engineering": { Icon: Cpu, color: BLUE },
...
const FALLBACK: SkillIcon = { Icon: Wrench, color: "#9ca9b0" };
...
export default function TechnologyIcon({
  ...
  const skill = getSkillIcon(name) ?? FALLBACK;
...
export const SKILL_ICON_MAP = SKILL_ICONS;
export { SKILL_ICONS };
