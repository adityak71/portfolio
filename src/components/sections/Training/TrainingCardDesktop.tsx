...
import { MONO_FONT, GREEN, TEXT_MUTED, EASING } from "@/config/theme";
import {
   TimelineNode,
...
interface TrainingCardDesktopProps {
   item: Training;
   index: number;
   accentColor: string;
   onClick?: () => void;
...
const TrainingCardDesktop = ({
   item,
   index,
   accentColor,
   onClick,
}: TrainingCardDesktopProps) => {
...
export default TrainingCardDesktop;
