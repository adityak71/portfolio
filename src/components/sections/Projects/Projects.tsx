...
const getFeaturedProjects = () => (projectsData.featured_projects || []) as Project[];
const getCollaborativeProjects = () => (projectsData.collaborative_projects || []) as Project[];
const getOtherProjects = () => (projectsData.other_projects || []) as Project[];
const getCommunityProjects = () => (projectsData.community_projects || []) as Project[];
const getSpotlightProjectId = () => projectsData.spotlight_project_id;
import {
   BLUE,
   DURATION,
   EASING,
...
import { parseProjectDate } from "@/lib/projectMetadata";
...
const Projects = () => {
   ...
   return (
      <section id="projects" className="py-20">
         <SectionHeader number="05" eyebrow="Things I've built" title="Projects" />
