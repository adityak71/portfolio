...
import useFreezeAnimations from "@/hooks/useMotionPreference";
 ...
 */
const ProjectCover = ({ projectId, title, accent, imageUrl }: ProjectCoverProps) => {
   ...
   } else if (cover && cover.kind === "image") {
      media = (
         <img
