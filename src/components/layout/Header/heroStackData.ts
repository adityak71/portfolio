import { SKILL_ICON_MAP } from "@/components/ui/TechnologyIcon";
...
const seenGlyphs = new Set<React.ComponentType<any>>();
for (const name of skillsData.hero_stack) {
   const skill = SKILL_ICON_MAP[name];
